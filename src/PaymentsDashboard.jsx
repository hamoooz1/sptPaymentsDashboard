...
export default function PaymentsDashboard() {
  ...
  }, [rows, payerCategory, paymentTypes, minAmt, maxAmt, search, fromDate, toDateFilter]);
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`inline-flex items-center px-3 py-2 rounded-md text-sm font-medium transition-colors ${
              darkMode ? 'bg-gray-700 text-white hover:bg-gray-600' : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50'
            }`}
          >
            {darkMode ? (
          ...
          <button
            ...
            onClick={() => csvDownload(filtered, "filtered_payments.csv")}
      ...
      <div className={`shadow-lg border rounded-xl overflow-hidden transition-all ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} backdrop-blur-sm`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          <div>
            ...
            <div
              className={`border-2 border-dashed rounded-xl p-8 text-center transition-all duration-300 ${
                isDragging ? "border-blue-500 bg-blue-50 dark:bg-blue-950/20 dark:border-blue-400 scale-105" : darkMode 
          ...
          <div className="space-y-3">
            ...
            <input 
              type="date" 
              className={`border rounded-lg p-2.5 w-full transition-all focus:ring-2 focus:outline-none font-medium ${
                darkMode 
